...
export default function App({ Component, pageProps, router }) {
    ...
    const description =
        meta.metaDescription || meta.description || 'Documentation for NeoStorefront.'
    ...
    return (
        <>
            <Title suffix="NeoStorefront">{meta.metaTitle || meta.title}</Title>
            <Head>
                ...
                <meta
                    key="og:url"
                    property="og:url"
                    content={`https://docs.neostorefront.com${router.pathname}`}
                />
